...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="KlientE.aspx.cs" Inherits="IIS.Inter_002.КлиентE" %>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlУлицаLabel" runat="server" Text="Улица" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlУлица" runat="server">
</asp:TextBox>

</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlДомLabel" runat="server" Text="Дом" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlДом" runat="server">
</asp:TextBox>

</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlКвартираLabel" runat="server" Text="Квартира" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlКвартира" runat="server">
</asp:TextBox>

</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlПочтовыйИндексLabel" runat="server" Text="Почтовый индекс" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlПочтовыйИндекс" runat="server">
</asp:TextBox>
