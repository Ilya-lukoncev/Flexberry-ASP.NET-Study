...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="OtchetE.aspx.cs" Inherits="IIS.Inter_002.ОтчетE" %>
...
<div>
	<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlКодОтчетаLabel" runat="server" Text="Код отчета" EnableViewState="False">
</asp:Label>
<ac:AlphaNumericTextBox CssClass="descTxt" ID="ctrlКодОтчета" Type="Numeric" runat="server">
...
<div style="clear: left">
	<ac:AjaxGroupEdit ID="ctrlСтрокаОтчета" runat="server" ReadOnly="false" />
</div>
<br/>
