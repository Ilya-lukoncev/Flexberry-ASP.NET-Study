...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="PostavkaE.aspx.cs" Inherits="IIS.Inter_002.ПоставкаE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass %> <%= Constants.EditFormHeaderCssClass %>">Поставка</h2>
...
<div>
	<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlКодПоставкиLabel" runat="server" Text="Код поставки" EnableViewState="False">
</asp:Label>
<ac:AlphaNumericTextBox CssClass="descTxt" ID="ctrlКодПоставки" Type="Numeric" runat="server">
...
<div style="clear: left">
	<ac:AjaxGroupEdit ID="ctrlСтрокаПоставки" runat="server" ReadOnly="false" />
</div>
<br/>
