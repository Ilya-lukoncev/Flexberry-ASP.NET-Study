...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="SkladE.aspx.cs" Inherits="IIS.Inter_002.СкладE" %>
...
<div>
	<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlКодСкладаLabel" runat="server" Text="Код склада" EnableViewState="False">
</asp:Label>
<ac:AlphaNumericTextBox CssClass="descTxt" ID="ctrlКодСклада" Type="Numeric" runat="server">
